...
ALTER TABLE Tache_fini ADD CONSTRAINT FK_TACHE_FINI_REF FOREIGN KEY (ref_tache) REFERENCES Utilisateur (ref_tache);
...
ALTER TABLE Tache_en_cours ADD CONSTRAINT FK_TACHE_EN_COURS_REF FOREIGN KEY (ref_tache) REFERENCES Utilisateur (ref_tache);

...
ALTER TABLE
    Est_assigne DROP CONSTRAINT FK_EST_ASSIGNE_REFUTILISATEUR;
...
ALTER TABLE
    Tache_fini DROP CONSTRAINT FK_TACHE_FINI_REF_REFUTILISATEUR;
...
ALTER TABLE
    Tache_en_cours DROP CONSTRAINT FK_TACHE_EN_COURS_REFUTILISATEUR;

ALTER TABLE
    Tache_en_cours DROP CONSTRAINT FK_TACHE_EN_COURS_REFPERIODICITE;

ALTER TABLE
    Tache_appartenant_a_liste DROP CONSTRAINT FK_TACHELISTE_REFTACHE;

ALTER TABLE
    Tache_appartenant_a_liste DROP CONSTRAINT FK_TACHELISTE_REFLISTE;
...
ALTER TABLE Travaille
ADD
    CONSTRAINT FK_TRAVAILLE_REFPROJET FOREIGN KEY (ref_projet) REFERENCES Projet (ref_projet);
...
ADD
    CONSTRAINT check_mot_de_passe_format CHECK (
        REGEXP_LIKE(
            mot_de_passe,
            '^[a-zA-Z0-9_]+$'
        )
...
ALTER TABLE Utilisateur
ADD
    CONSTRAINT check_login_format CHECK (
        REGEXP_LIKE(
            login,
            '^[a-z]{1}[a-z]{7}[0-9]{2}$'
        )
